...
var SvgPanZoom = function(svg, isClipPath, options) {
...
SvgPanZoom.prototype.init = function(svg, isClipPath, options) {
  var that = this;
...
module.exports = {
   ...
   */
  getOrCreateViewport: function(svg, settings, selector) {
    var viewport = null;
    ...
    if (settings.isClipPath) {
      // If no favorable group element exists then create one
      if (!viewport) {
        var defs = document.createElementNS(this.svgNS, "defs");
        viewport = document.createElementNS(this.svgNS, "clipPath");
        viewport.setAttribute("id", "countries");
...
svgMap.prototype.createMap = function () {
  ...
  this.mapPanZoom = svgPanZoom(this.mapImage, {
    zoomEnabled: true,
    isClipPath: this.options.isClipPath,
    fit: true,
    center: true,
